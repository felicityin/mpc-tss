...
import (
	...
	"github.com/felicityin/mpc-tss/cggmp/threshold/auxiliary"
...
func TestE2EConcurrent(t *testing.T) {
	...
	keys, signPIDs, err := keygen.LoadKeygenTestFixturesRandomSet(keygen.Ecdsa, testThreshold+1, testParticipants)
