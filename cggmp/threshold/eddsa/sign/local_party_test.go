...
func TestE2EConcurrent(t *testing.T) {
	...
	keys, signPIDs, err := keygen.LoadKeygenTestFixturesRandomSet(keygen.Eddsa, testThreshold+1, testParticipants)
	assert.NoError(t, err, "should load keygen fixtures")

	auxs, _, err := auxiliary.LoadAuxTestFixtures(keygen.Eddsa, testThreshold+1)
